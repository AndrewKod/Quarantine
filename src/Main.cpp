...
#define MYAPPLICATION_NAME L"Quarantine"
...
#endif
{
	...
	Core::RunApplicationWithDelegate(new QuarantineAppDelegate());
#else
	Core::RunApplicationWithDelegate(argc, argv, new QuarantineAppDelegate());
#endif
